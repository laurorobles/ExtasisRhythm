...
ExtasisRhythmProcessor::ExtasisRhythmProcessor()
    ...
    appSupport.getChildFile ("ExtasisRhythm").deleteRecursively();
    appSupport.getChildFile ("Extasis Rhythm").deleteRecursively();
    ...
    samplesFolder = juce::File::getSpecialLocation(juce::File::userHomeDirectory)
