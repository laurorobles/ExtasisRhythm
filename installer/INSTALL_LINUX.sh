#!/bin/bash
echo "============================================================"
echo " ExtasisRhythm - Linux Automated Installer"
echo "============================================================"
...
if [ -d "$INSTALL_DIR/ExtasisRhythm.vst3" ]; then
    cp -R "$INSTALL_DIR/ExtasisRhythm.vst3" "$VST3_DIR/"
fi

echo "[2/2] Installing CLAP Plugin to $CLAP_DIR..."
mkdir -p "$CLAP_DIR"
if [ -f "$INSTALL_DIR/ExtasisRhythm.clap" ]; then
    cp "$INSTALL_DIR/ExtasisRhythm.clap" "$CLAP_DIR/"
fi
